...
<template>
    ...
    <div class="container mx-auto mt-2">
        ...
        <div class="border border-gray-200 rounded-md mt-4 p-4" v-if="hasPermission('user_list')" >
            <div class="overflow-x-auto">
                <table class="mt-2 text-center">
                    ...
                    <tr>
                        ...
                        <th v-if="hasPermission('user_edit')">گۆڕین</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr v-for="user in users.data" :key="user.id">
                        ...
                        <td>
                            <Link :href="route('users.edit',{id:user.id})" class="table_btn" v-if="hasPermission('user_edit')">
