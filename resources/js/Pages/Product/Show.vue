...
<template>
    <Head title="بینینی کاڵا - "/>
    <div class="container mx-auto mt-4">
        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-md">
            <h1 class="text-sm lg:text-xl">بینینی کاڵا / <span class="text-red-600">{{ props.product.name }}</span></h1>
            <Link :href="route('products.edit',{id:props.product.id})" class="primary-btn">
                <span>گۆڕین</span>
