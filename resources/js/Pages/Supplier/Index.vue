    ...
    <div class="container mx-auto mt-2 ">
        <div class="flex items-center justify-between  border border-gray-200 rounded-md p-4">
            ...
            <div class="flex  items-center gap-2 ">
                ...
                <Link class="primary-btn flex items-center justify-between gap-2" :href="route('suppliers.create')" v-if="hasPermission('supplier_add')">
            ...
            <div class="overflow-x-auto">
                <table class="mt-2 text-center">
                    ...
                    <tr v-for="supplier in props.suppliers.data" :key="supplier.id">
                        ...
                        <td class="space-x-1">
                            <Link :href="route('suppliers.purchases', supplier.id)" class="table_btn" v-if="hasPermission('supplier_edit')">
                        ...
                        <td class="space-x-1">
                            <Link :href="route('suppliers.show',{id:supplier.id})" class="table_btn" v-if="hasPermission('supplier_edit')">
